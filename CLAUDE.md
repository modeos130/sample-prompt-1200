...
Canonical formula for new prompt packs: `docs/PROMPT_DNA_FORMULA.md`. Use that
file as the source of truth for the 1000-character limit, weirdness/style
influence guidance, required genre fields, and proven Suno prompt structure.
