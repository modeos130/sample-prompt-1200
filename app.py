...
# Using single quotes for the string to prevent triple-quote clip errors
css_code = """
<style>
...
# --- BRANDING ---
st.markdown('<div class="logo-container"><div class="logo-130">130</div><div class="logo-mode">Mode</div></div><div style="text-align: center; margin-bottom: 30px;"><h1 style="color: #8e8e8e; font-size: 28px; font-weight: 900; margin:0;">BOOMAN SYSTEMS</h1><p style="color: #444; font-size: 10px; font-weight: bold; letter-spacing: 4px;">SP-1200 PROMPT GENERATOR</p></div>', unsafe_allow_html=True)
